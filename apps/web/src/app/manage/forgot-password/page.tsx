...
export default function ForgotPasswordPage() {
  ...
  // Step 1: Send reset code via real endpoint
  ...
  // Step 2: Reset password via real endpoint
      ...
      <Card className="w-full max-w-[440px] glass-card border-white/40 shadow-2xl relative z-10 p-2">
        ...
        <CardFooter className="flex flex-col space-y-4">
          <div className="text-sm text-center text-slate-500 dark:text-slate-400 w-full">
            ...
            <Link href="/manage/login" className="font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400 underline-offset-4 hover:underline">
              Sign in
            </Link>
          </div>
        </CardFooter>
